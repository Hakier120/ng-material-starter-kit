...
import { NewFilteredProductListComponent } from './components/new-filtered-product-list/new-filtered-product-list.component';
...
import { NewFilteredProductListComponentModule } from './components/new-filtered-product-list/new-filtered-product-list.component-module';
import { SortedProductListComponentModule } from './components/sorted-product-list/sorted-product-list.component-module';

@NgModule({
  imports: [RouterModule.forRoot([{ path: 'categories', component: CategoryComponent }, { path: 'crypto', component: SymbolssComponent }, { path: 'public-holidays', component: PublicHolidaysComponent }, { path: 'checkbox-categories', component: CategoriesCheckboxComponent }, { path: 'categories-menu', component: CategoriesMenuComponent }, { path: 'create-product', component: ProductFormComponent }, { path: 'create-employee', component: CreateEmployeeComponent }, { path: 'login', component: LoginFormComponent }, { path: 'register', component: RegisterFormComponent }, { path: 'cat-fact', component: CatFactComponent }, { path: 'age/:name', component: AgePredictionComponent }, { path: 'product/:id', component: DetailsComponent }, { path: 'cart/:id', component: CartListComponent }, { path: 'user/:id', component: UserDetailsComponent }, { path: 'newuser/:name', component: UserDetComponent }, { path: 'products/:category', component: FilteredProductListComponent }, { path: 'products', component: NewFilteredProductListComponent }, { path: 'sorted-products', component: SortedProductListComponent }]), ProductsServiceModule, CategoryComponentModule, SymbolssComponentModule, SymbolsServiceModule, PublicHolidaysComponentModule, HolidaysServiceModule, CategoriesServiceModule, CategoriesCheckboxComponentModule, CategoriesMenuComponentModule, ProductFormComponentModule, NewProductServiceModule, CreateEmployeeComponentModule, EmployeesServiceModule, LoginFormComponentModule, LoginServiceModule, ProductCategoriesServiceModule, RegisterFormComponentModule, RegistersServiceModule, CatFactComponentModule, CatServiceModule, AgePredictionComponentModule, AgeServiceModule, DetailsComponentModule, DetailsServiceModule, CartListComponentModule, CartServiceModule, UserDetailsComponentModule, UserServiceModule, NewServiceModule, UserDetComponentModule, FilteredProductListComponentModule, NewCategoriesServiceModule, NewFilteredProductListComponentModule, SortedProductListComponentModule],
